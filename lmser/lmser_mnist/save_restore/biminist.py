...
y_pre = lmser_model.inference2_biminist(x_data, 256,144)[0]
x_pre = lmser_model.generate2_biminist( x_data, 256, 144)
'''hidden1 = lmser_model.inference_biminist(x_data, 256, 144, 64)[9]
hidden2 = lmser_model.inference_biminist(x_data, 256, 144, 64)[10]
'''
...
np.save('biminist_unsurpervised/train_loss2layers', train_loss)
np.save('biminist_unsurpervised/train_accu2layers', train_accu)
saver.save(sess, 'biminist_unsurpervised/biminist_2layers.ckpt')
plt.ioff()
